...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(() => {
    ...
    const build = () => {
      ...
      splitRef.current = new GSAPSplitText(el, {
        type: 'chars', charsClass: 'shuffle-char',
        wordsClass: 'shuffle-word', linesClass: 'shuffle-line',
        smartWrap: true, reduceWhiteSpace: false,
      });
      ...
      chars.forEach(ch => {
        ...
        if (colorFrom) (inner.style as CSSStyleDeclaration & Record<string, string>).color = colorFrom;
  ...
  const classes = useMemo(
    () => `inline-block whitespace-normal break-words will-change-transform ${ready ? 'visible' : 'invisible'} ${className}`.trim(),
    [ready, className]
  );
